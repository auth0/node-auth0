...
describe("Passwordless", () => {
    ...
    describe("#loginWithEmail", () => {
        it("should require email", async () => {
            const passwordless = new Passwordless(opts);
            await expect(passwordless.loginWithEmail({ code: "foo" } as LoginWithEmailRequest)).rejects.toThrow(
                "Required parameter requestParameters.email was null or undefined.",
            );
        });
    ...
    describe("#loginWithSMS", () => {
        it("should require phone_number", async () => {
            const passwordless = new Passwordless(opts);
            await expect(passwordless.loginWithSMS({ code: "foo" } as LoginWithSMSRequest)).rejects.toThrow(
                "Required parameter requestParameters.phone_number was null or undefined.",
            );
        });
