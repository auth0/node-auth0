...
import { ResourceServersManager, ManagementClient, ResourceServerProofOfPossessionMechanismEnum } from "auth0-legacy";
    ...
    describe("#getAll", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            ...
            resourceServers.getAll().then((resourceServers) => {
                expect(Array.isArray(resourceServers.data)).toBe(true);
    ...
    describe("#get", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            ...
            resourceServers.get(params).then((resourceServer) => {
                ...
                expect(resourceServer.data.proof_of_possession?.mechanism).toBe(data.proof_of_possession.mechanism);
                expect(resourceServer.data.proof_of_possession?.required).toBe(data.proof_of_possession.required);
