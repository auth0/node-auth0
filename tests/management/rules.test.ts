...
import { RulesManager, ManagementClient } from "auth0-legacy";
...
describe("RulesManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it("should include the token in the Authorization header", async () => {
            ...
            const request = nock(API_URL).get("/rules").matchHeader("Authorization", `Bearer ${token}`).reply(200, []);
    ...
    describe("#create", () => {
        ...
        it("should include the token in the Authorization header", async () => {
            ...
            const request = nock(API_URL).post("/rules").matchHeader("Authorization", `Bearer ${token}`).reply(200, {});
