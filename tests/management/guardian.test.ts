...
describe("GuardianManager", () => {
    ...
    describe("#deleteGuardianEnrollment", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.deleteGuardianEnrollment(data)).rejects.toThrowError(ManagementApiError);
        });
    });
    ...
    describe("#getPushNotificationProviderAPNS", () => {
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.getPushNotificationProviderAPNS()).rejects.toThrowError(ManagementApiError);
        });
        ...
        it('should pass the body of the response to the "then" handler', async () => {
            ...
            await expect(guardian.getPushNotificationProviderAPNS()).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#getPhoneFactorSelectedProvider", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.getPhoneFactorSelectedProvider()).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#getPhoneFactorProviderTwilio", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.getPhoneFactorProviderTwilio()).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#getPushNotificationSelectedProvider", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.getPushNotificationSelectedProvider()).rejects.toThrowError(ManagementApiError);
        });
        ...
        it('should pass the body of the response to the "then" handler', async () => {
            ...
            await expect(guardian.getPushNotificationSelectedProvider()).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#getPushNotificationProviderSNS", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.getPushNotificationProviderSNS()).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#updatePushNotificationProviderAPNS", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePushNotificationProviderAPNS(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).patch("/guardian/factors/push-notification/providers/apns").reply(200, data);

            await expect(guardian.updatePushNotificationProviderAPNS(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#updatePushNotificationProviderFCM", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePushNotificationProviderFCM(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).patch("/guardian/factors/push-notification/providers/fcm").reply(200, data);

            await expect(guardian.updatePushNotificationProviderFCM(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#updatePushNotificationProviderSNS", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePushNotificationProviderSNS(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).patch("/guardian/factors/push-notification/providers/sns").reply(200, data);

            await expect(guardian.updatePushNotificationProviderSNS(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#createEnrollmentTicket", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.createEnrollmentTicket(params)).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#setPushNotificationProviderAPNS", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setPushNotificationProviderAPNS(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/push-notification/providers/apns").reply(200, data);

            await expect(guardian.setPushNotificationProviderAPNS(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#setPhoneFactorTemplates", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setPhoneFactorTemplates(params)).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#setPushNotificationProviderFCM", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setPushNotificationProviderFCM(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/push-notification/providers/fcm").reply(200, data);

            await expect(guardian.setPushNotificationProviderFCM(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#updatePhoneFactorMessageTypes", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePhoneFactorMessageTypes(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/phone/message-types").reply(200, data);

            await expect(guardian.updatePhoneFactorMessageTypes(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#updatePhoneFactorSelectedProvider", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePhoneFactorSelectedProvider(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/phone/selected-provider").reply(200, data);

            await expect(guardian.updatePhoneFactorSelectedProvider(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#setPushNotificationSelectedProvider", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setPushNotificationSelectedProvider(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/push-notification/selected-provider").reply(200, data);

            await expect(guardian.setPushNotificationSelectedProvider(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#setSmsSelectedProvider", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setSmsSelectedProvider(params)).rejects.toThrowError(ManagementApiError);
        });
    ...
    describe("#setSmsFactorProviderTwilio", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setSmsFactorProviderTwilio(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/sms/providers/twilio").reply(200, data);

            await expect(guardian.setSmsFactorProviderTwilio(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#setPushNotificationProviderSNS", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.setPushNotificationProviderSNS(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/push-notification/providers/sns").reply(200, data);

            await expect(guardian.setPushNotificationProviderSNS(params)).resolves.toHaveProperty("data", data);
        });
    });
    ...
    describe("#updatePhoneFactorProviderTwilio", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            await expect(guardian.updatePhoneFactorProviderTwilio(params)).rejects.toThrowError(ManagementApiError);
        });

        it('should pass the body of the response to the "then" handler', async () => {
            nock(API_URL).put("/guardian/factors/phone/providers/twilio").reply(200, data);

            await expect(guardian.updatePhoneFactorProviderTwilio(params)).resolves.toHaveProperty("data", data);
        });
    });
});
