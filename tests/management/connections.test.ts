...
import { ConnectionsManager, ConnectionCreateStrategyEnum, ManagementClient, RequiredError } from "auth0-legacy";
...
describe("ConnectionsManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it("should pass the parameters in the query-string", (done) => {
            ...
            connections.getAll({ include_fields: true, fields: "test", strategy: ["ad", "adfs"] }).then(() => {
                expect(request.isDone()).toBe(true);
    ...
    describe("#delete user", () => {
        ...
        it("should require a connection id", async () => {
            await expect(connections.deleteUserByEmail({ email } as any)).rejects.toThrowError(RequiredError);
        });

        it("should require an email", async () => {
            await expect(connections.deleteUserByEmail({ id } as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#createScimConfiguration", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            ...
            connections.createScimConfiguration({ id: connectionId }, payload).then((connection) => {
                ...
                expect(connection.data.mapping).toEqual(response.mapping);
    ...
    describe("#getScimConfiguration", () => {
        ...
        let request: nock.Scope;
        beforeEach(() => {
            request = nock(API_URL).get(`/connections/${connectionId}/scim-configuration`).reply(200, response);
        });
    ...
    describe("#deleteScimConfiguration", () => {
        ...
        let request: nock.Scope;
        beforeEach(() => {
            request = nock(API_URL).delete(`/connections/${connectionId}/scim-configuration`).reply(204, {});
        });
    ...
    describe("#createScimToken", () => {
        ...
        const response = {
            ...
            token: "tok_Gf3Q54Mjm88rifWy.1a76dccc1de257668e6f071b557ee282671ae31ed5c1d07c3a85262ce88e161a",
            scopes: ["get:users", "post:users"],
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            nock.cleanAll();
            nock(API_URL).post(`/connections/${connectionId}/scim-configuration/tokens`).reply(201, response);
            ...
            connections.createScimToken({ id: connectionId }, payload).then((connection) => {
                ...
                expect(connection.data.scopes).toEqual(response.scopes);
                expect(connection.data.created_at).toBe(response.created_at);
    ...
    describe("#getScimTokens", () => {
        ...
        let request: nock.Scope;
        beforeEach(() => {
            request = nock(API_URL).get(`/connections/${connectionId}/scim-configuration/tokens`).reply(200, response);
        });

        it("should return a promise if no callback is given", (done) => {
            connections.getScimTokens({ id: connectionId }).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            nock.cleanAll();
            nock(API_URL).get(`/connections/${connectionId}/scim-configuration/tokens`).reply(200, response);

            connections.getScimTokens({ id: connectionId }).then((connection) => {
                expect(connection.data).toEqual(response);
    ...
    describe("#deleteScimToken", () => {
        ...
        it("should pass any errors to the promise catch handler", (done) => {
            nock.cleanAll();
            nock(API_URL).delete(`/connections/${connectionId}/scim-configuration/tokens/${tokenId}`).reply(500, {});
    ...
    describe("#getDefaultScimMapping", () => {
        ...
        it("should pass any errors to the promise catch handler", (done) => {
            nock.cleanAll();
            nock(API_URL).get(`/connections/${connectionId}/scim-configuration/default-mapping`).reply(500, {});
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            nock.cleanAll();
            nock(API_URL).get(`/connections/${connectionId}/scim-configuration/default-mapping`).reply(200, response);
    ...
    describe("#getKeys", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            connections.getKeys({ id: connectionId }).then(done.bind(null, null)).catch(done.bind(null, null));
        });
    ...
    describe("#rotateKeys", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            connections.rotateKeys({ id: connectionId }).then(done.bind(null, null)).catch(done.bind(null, null));
        });
