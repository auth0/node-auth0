...
describe("UsersManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it("should include the token in the Authorization header", async () => {
            ...
            const request = nock(API_URL).get("/users").matchHeader("Authorization", `Bearer ${token}`).reply(200, []);
    ...
    describe("#getByEmail", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            expect(usersByEmailManager.getByEmail({ email: "" }).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#create", () => {
        ...
        it("should include the token in the Authorization header", async () => {
            ...
            const request = nock(API_URL).post("/users").matchHeader("Authorization", `Bearer ${token}`).reply(200, {});
    ...
    describe("#unlink", () => {
        ...
        it("should include the token in the authorization header", async () => {
            ...
            const request = nock(API_URL).delete(url).matchHeader("authorization", `Bearer ${token}`).reply(200, []);
    ...
    describe("#deleteMultifactorProvider", () => {
        ...
        it("should return a promise when no callback is given", (done) => {
            expect(usersManager.deleteMultifactorProvider(data).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#logs", () => {
        ...
        it("should include the token in the authorization header", async () => {
            ...
            const request = nock(API_URL).get(url).matchHeader("authorization", `Bearer ${token}`).reply(200, []);
    ...
    describe("#regenerateRecoveryCode", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.regenerateRecoveryCode({} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#invalidateRememberBrowser", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.invalidateRememberBrowser({} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.invalidateRememberBrowser(data).then(() => done())).toBeInstanceOf(Promise);
        });

        it("should pass any errors to the promise catch handler", async () => {
            nock.cleanAll();

            nock(API_URL).post(`/users/${data.id}/multifactor/actions/invalidate-remember-browser`).reply(500, {});
    ...
    describe("#assignRoles", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.assignRoles({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#removeRoles", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.deleteRoles({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#assignPermissions", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.assignPermissions({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.assignPermissions(data, {} as any).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#deletePermissions", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.deletePermissions({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.deletePermissions(data, {} as any).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#deleteAllAuthenticators", () => {
        ...
        it("should validate empty id", async () => {
            await expect(usersManager.deleteAllAuthenticators({} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.deleteAllAuthenticators(params).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#getSessions", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.getSessions({ user_id: data.id }).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#deleteSessions", () => {
        ...
        it("should return a promise when no callback is given", (done) => {
            expect(usersManager.deleteSessions({ user_id: id }).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#getRefreshTokens", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            expect(usersManager.getRefreshTokens({ user_id: data.id }).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#deleteRefreshTokens", () => {
        ...
        it("should return a promise when no callback is given", (done) => {
            expect(usersManager.deleteRefreshTokens({ user_id: id }).then(() => done())).toBeInstanceOf(Promise);
        });
    ...
    describe("#getAllTokensets", () => {
        ...
        it('should pass the body of the response to the "then" handler', async () => {
            ...
            expect(Array.isArray(tokensets.data)).toBe(true);
    ...
    describe("#deleteTokenset", () => {
        ...
        beforeEach(() => {
            scope = nock(API_URL).delete(`/users/${id}/federated-connections-tokensets/${tokenset_id}`).reply(200, {});
        });

        it("should return a promise when no callback is given", (done) => {
            expect(usersManager.deleteTokenset({ id: id, tokenset_id: tokenset_id }).then(() => done())).toBeInstanceOf(
                Promise,
            );
        });
        ...
        it("should pass any errors to the promise catch handler", async () => {
            ...
            nock(API_URL).delete(`/users/${id}/federated-connections-tokensets/${tokenset_id}`).reply(500, {});
