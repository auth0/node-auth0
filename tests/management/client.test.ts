...
describe("ClientsManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            clients.getAll().then((clients) => {
                ...
                expect(clients.data[0].token_quota).toEqual(response[0].token_quota);
    ...
    describe("#create", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            clients.create(data).then((client) => {
                ...
                expect(client.data.token_quota).toEqual(response.token_quota);
                done();
            });
        });
    });
    ...
    describe("#rotateSecret", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            clients.rotateClientSecret({ client_id: id }, {}).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it("should return an error when client_id is not sent", async () => {
            await expect(clients.rotateClientSecret({} as any)).rejects.toThrow();
        });

        it("should include the new data in the body of the request", (done) => {
            nock.cleanAll();

            const request = nock(API_URL).post(`/clients/${id}/rotate-secret`).reply(200, { client_id: "123" });
    ...
    describe("#getCredentials", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            clients
                ...
                .then((credentials) => {
                    expect(Array.isArray(credentials.data)).toBe(true);
    ...
    describe("#updateCredential", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            clients.updateCredential({ client_id: "123", credential_id: "abc" }, data).then((credential) => {
                expect(credential.data.kid).toBe(response.kid);
    ...
    describe("#deleteCredential", () => {
        ...
        it("should return a promise when no callback is given", (done) => {
            clients.deleteCredential({ client_id: "123", credential_id: "abc" }).then(done.bind(null, null));
        });
    ...
    describe("#getEnabledConnections", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            ...
            nock.cleanAll();
            const request = nock(API_URL).get(`/clients/${client_id}/connections`).reply(200, responseObj);
