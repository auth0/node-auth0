...
import { TenantsManager, ManagementClient, TenantSettings } from "auth0-legacy";
...
describe("TenantManager", () => {
    ...
    describe("#updateSettings", () => {
        ...
        it("should perform a PATCH request to /api/v2/tenants/settings", async () => {
            ...
            expect(updatedTenant.data.default_token_quota).toEqual(response.default_token_quota);
            expect(request.isDone()).toBe(true);
        });
