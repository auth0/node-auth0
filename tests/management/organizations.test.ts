...
describe("OrganizationsManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it('should pass the body of the response to the "then" handler', (done) => {
            ...
            organizations.getAll().then((result) => {
                ...
                expect(result.data[0].token_quota).toEqual(data[0].token_quota);
    ...
    describe("#getByName", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            organizations.getByName({ name: data.name }).then(done.bind(null, null)).catch(done.bind(null, null));
        });
    ...
    describe("#update", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            organizations.update({ id: "org_123" }, {}).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it("should include the new data in the body of the request", (done) => {
            ...
            const request = nock(API_URL).patch(`/organizations/${data.id}`, { name: "test" }).reply(200, {});
    ...
    describe("#getEnabledConnection", () => {
        ...
        it("should pass any errors to the promise catch handler", (done) => {
            ...
            nock(API_URL).get(`/organizations/${data.id}/enabled_connections/${data.connectionId}`).reply(500, {});
    ...
    describe("#addEnabledConnection", () => {
        ...
        it("should pass the data in the body of the request", (done) => {
            ...
            const request = nock(API_URL).post(`/organizations/${data.id}/enabled_connections`, body).reply(200, {});
    ...
    describe("#updateEnabledConnection", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            organizations.updateEnabledConnection(data, body).then(done.bind(null, null)).catch(done.bind(null, null));
        });

        it("should pass any errors to the promise catch handler", (done) => {
            nock.cleanAll();

            nock(API_URL).patch(`/organizations/${data.id}/enabled_connections/${data.connectionId}`).reply(500, {});
        ...
        it("should return error when id is not sent", async () => {
            await expect(organizations.updateEnabledConnection({} as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });

        it("should return error when connectionId is not sent", () => {
            expect(organizations.updateEnabledConnection({ id: "test" } as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });
    ...
    describe("#deleteEnabledConnection", () => {
        ...
        it("should validate empty organizationId", async () => {
            await expect(organizations.deleteEnabledConnection({} as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });

        it("should validate empty connectionId", async () => {
            await expect(organizations.deleteEnabledConnection({ id: "123" } as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });

        it("should return a promise if no callback is given", (done) => {
            organizations.deleteEnabledConnection(data).then(done.bind(null, null)).catch(done.bind(null, null));
        });

        it("should pass any errors to the promise catch handler", (done) => {
            nock.cleanAll();

            nock(API_URL).delete(`/organizations/${data.id}/enabled_connections/${data.connectionId}`).reply(500, {});
    ...
    describe("#addMembers", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            organizations.addMembers(data, { members: [] }).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it("should return error when id is not sent", async () => {
            await expect(organizations.addMembers({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#removeMembers", () => {
        ...
        it("should validate empty organizationId", async () => {
            await expect(organizations.deleteMembers({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            organizations.deleteMembers(data, body).then(done.bind(null, null)).catch(done.bind(null, null));
        });
    ...
    describe("#getMemberRoles", () => {
        ...
        beforeEach(() => {
            request = nock(API_URL).get(`/organizations/${data.id}/members/${data.user_id}/roles`).reply(200, []);
        });
    ...
    describe("#addMemberRoles", () => {
        ...
        it("should return a promise if no callback is given", (done) => {
            organizations.addMemberRoles(data, body).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it("should return error when id is not sent", async () => {
            await expect(organizations.addMemberRoles({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#deleteMemberRoles", () => {
        ...
        it("should validate empty id", async () => {
            await expect(organizations.deleteMemberRoles({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return a promise if no callback is given", (done) => {
            organizations.deleteMemberRoles(data, body).then(done.bind(null, null)).catch(done.bind(null, null));
        });
        ...
        it("should return error when user_id is not sent", () => {
            expect(organizations.deleteMemberRoles({ id: "org_1" } as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });
    ...
    describe("#getInvitation", () => {
        ...
        beforeEach(() => {
            request = nock(API_URL).get(`/organizations/${data.id}/invitations/${data.invitation_id}`).reply(200, {});
        });
        ...
        it("should return error when id is not sent", async () => {
            await expect(organizations.getInvitation({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });

        it("should return error when invitation_id is not sent", async () => {
            await expect(organizations.getInvitation({ id: "123" } as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });
    ...
    describe("#createInvitation", () => {
        ...
        it("should return error when id is not sent", async () => {
            await expect(organizations.createInvitation({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
    ...
    describe("#deleteInvitation", () => {
        ...
        it("should validate empty id", async () => {
            await expect(organizations.deleteInvitation({} as any, {} as any)).rejects.toThrowError(RequiredError);
        });
        ...
        it("should pass any errors to the promise catch handler", (done) => {
            ...
            nock(API_URL).delete(`/organizations/${data.id}/invitations/${data.invitation_id}`, {}).reply(500, {});
        ...
        it("should return error when invitation_id is not sent", () => {
            expect(organizations.deleteInvitation({ id: "org_123" } as any, {} as any)).rejects.toThrowError(
                RequiredError,
            );
        });
    ...
    describe("#getOrganizationClientGrants", () => {
        ...
        it("should pass any errors to the promise catch handler", async () => {
            request = nock(API_URL).get(`/organizations/${data.id}/client-grants`).query(true).reply(500, {});
