...
import { GrantsManager, ManagementClient, RequiredError } from "auth0-legacy";
...
describe("GrantsManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it("should include the token in the Authorization header", (done) => {
            ...
            const request = nock(API_URL).get("/grants").matchHeader("Authorization", `Bearer ${token}`).reply(200, []);
