...
import { HookCreateTriggerIdEnum, HooksManager, ManagementClient } from "auth0-legacy";
...
describe("HooksManager", () => {
    ...
    describe("#getAll", () => {
        ...
        it("should include the token in the Authorization header", (done) => {
            ...
            const request = nock(API_URL).get("/hooks").matchHeader("Authorization", `Bearer ${token}`).reply(200, []);
