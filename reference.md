...
<details><summary><code>client.organizations.discoveryDomains.<a href="/src/management/api/resources/organizations/resources/discoveryDomains/client/Client.ts">list</a>(id, { ...params }) -> core.Page<Management.OrganizationDiscoveryDomain></code></summary>
<dl>
<dd>
...
```typescript
const response = await client.organizations.discoveryDomains.list("id", {
    from: "from",
    take: 1,
});
for await (const item of response) {
