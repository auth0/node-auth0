...
var clientInfo = { name: 'node-auth0', version: pjson.version };

function authRequest(accessToken) {
  if (accessToken && typeof accessToken === 'string') {
    // var encodedClientInfo = new Buffer(JSON.stringify(Auth0.clientInfo), 'base64').toString();
    var encodedClientInfo = Base64Url.encode(JSON.stringify(Auth0.clientInfo));
