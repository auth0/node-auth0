...
import { RequestOpts, InitOverrideFunction, HTTPQuery, Configuration, Middleware, FetchAPI } from "./models.js";
...
function querystringSingleKey(
    key: string,
    value: string | number | null | undefined | boolean | Array<string | number | null | boolean> | HTTPQuery,
): string {
 ...
 * @private
 */
export async function parseFormParam(originalValue: number | boolean | string | Blob): Promise<string | Blob> {
