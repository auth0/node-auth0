...
export class UserGrantsClient {
    protected readonly _options: UserGrantsClient.Options;
    ...
    public async list(
        ...
        return new core.Page<Management.UserGrant, Management.ListUserGrantsOffsetPaginatedResponseContent>({
            ...
            hasNextPage: (response) => (response?.grants ?? []).length >= Math.floor(request?.per_page ?? 1),
     ...
     */
    public delete(id: string, requestOptions?: UserGrantsClient.RequestOptions): core.HttpResponsePromise<void> {
