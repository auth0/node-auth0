...
export class RulesConfigsClient {
    protected readonly _options: RulesConfigsClient.Options;
    ...
    ): core.HttpResponsePromise<Management.RulesConfig[]> {
     ...
     */
    public delete(key: string, requestOptions?: RulesConfigsClient.RequestOptions): core.HttpResponsePromise<void> {
