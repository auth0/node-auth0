...
export class FlowsClient {
    protected readonly _options: FlowsClient.Options;
    ...
    public get vault(): VaultClient {
        return (this._vault ??= new VaultClient(this._options));
    }
    ...
    public async list(
        ...
        return new core.Page<Management.FlowSummary, Management.ListFlowsOffsetPaginatedResponseContent>({
            ...
            hasNextPage: (response) => (response?.flows ?? []).length >= Math.floor(request?.per_page ?? 1),
