...
export class GroupsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Management.Group, Management.ListUserRoleSourceGroupsResponseContent>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Management.ListUserRoleSourceGroupsRequestParameters,
            ): Promise<core.WithRawResponse<Management.ListUserRoleSourceGroupsResponseContent>> => {
        ...
        return new core.Page<Management.Group, Management.ListUserRoleSourceGroupsResponseContent>({
