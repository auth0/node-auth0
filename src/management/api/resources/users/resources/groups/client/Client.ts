...
export class Groups {
    ...
    public async get(
    ...
    ): Promise<core.Page<Management.UserGroupsResponseSchema, Management.GetUserGroupsPaginatedResponseContent>> {
            ...
            async (
                ...
                const _response = await (this._options.fetcher ?? core.fetcher)({
                    url: core.url.join(
                        ...
                        `users/${core.url.encodePathParam(id)}/groups`,
                    ),
                    method: "GET",
                    headers: _headers,
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Management.GetUserGroupsPaginatedResponseContent,
        ...
        return new core.Page<Management.UserGroupsResponseSchema, Management.GetUserGroupsPaginatedResponseContent>({
