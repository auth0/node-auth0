...
export class Groups {
    ...
    public async get(
    ...
    ): Promise<core.Page<Management.UserGroupsResponseSchema>> {
        ...
        return new core.Pageable<Management.GetUserGroupsPaginatedResponseContent, Management.UserGroupsResponseSchema>(
            {
