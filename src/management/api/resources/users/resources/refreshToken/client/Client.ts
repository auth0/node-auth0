...
export class RefreshTokenClient {
            ...
            async (
                ...
                const _response = await (this._options.fetcher ?? core.fetcher)({
                    url: core.url.join(
                        ...
                        `users/${core.url.encodePathParam(user_id)}/refresh-tokens`,
                    ),
                    method: "GET",
                    headers: _headers,
     ...
     */
    public delete(user_id: string, requestOptions?: RefreshTokenClient.RequestOptions): core.HttpResponsePromise<void> {
