...
export class AuthenticatorsClient {
     ...
     */
    public deleteAll(id: string, requestOptions?: AuthenticatorsClient.RequestOptions): core.HttpResponsePromise<void> {
    ...
    private async __deleteAll(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `users/${core.url.encodePathParam(id)}/authenticators`,
            ),
            method: "DELETE",
            headers: _headers,
