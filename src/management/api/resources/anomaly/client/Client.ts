...
export class Anomaly {
     ...
     * @param {Anomaly.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public checkIfIpIsBlocked(
        id: Management.AnomalyIpFormat,
        requestOptions?: Anomaly.RequestOptions,
    ): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__checkIfIpIsBlocked(id, requestOptions));
    }

    private async __checkIfIpIsBlocked(
        id: Management.AnomalyIpFormat,
        requestOptions?: Anomaly.RequestOptions,
    ...
    public deleteBlockedIp(
        ...
        return core.HttpResponsePromise.fromPromise(this.__deleteBlockedIp(id, requestOptions));
    }

    private async __deleteBlockedIp(
        id: Management.AnomalyIpFormat,
        requestOptions?: Anomaly.RequestOptions,
    ): Promise<core.WithRawResponse<void>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
