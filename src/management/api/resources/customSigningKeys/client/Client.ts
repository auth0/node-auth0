...
export declare namespace CustomSigningKeys {
...
export class CustomSigningKeys {
    protected readonly _options: CustomSigningKeys.Options;

    constructor(_options: CustomSigningKeys.Options) {
     ...
     *
     * @param {CustomSigningKeys.RequestOptions} requestOptions - Request-specific configuration.
     *
     ...
     */
    public delete(requestOptions?: CustomSigningKeys.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__delete(requestOptions));
    }

    private async __delete(requestOptions?: CustomSigningKeys.RequestOptions): Promise<core.WithRawResponse<void>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
