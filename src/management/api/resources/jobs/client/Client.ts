...
import type { GetJobResponseContent } from "../../../types/GetJobResponseContent.js";
...
export class Jobs {
     ...
     */
    public get(id: string, requestOptions?: Jobs.RequestOptions): core.HttpResponsePromise<GetJobResponseContent> {
    ...
    private async __get(
    ...
    ): Promise<core.WithRawResponse<GetJobResponseContent>> {
        ...
        if (_response.ok) {
            return { data: _response.body as GetJobResponseContent, rawResponse: _response.rawResponse };
        }
