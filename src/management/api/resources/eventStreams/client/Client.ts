...
export class EventStreamsClient {
    protected readonly _options: EventStreamsClient.Options;
    ...
    public get deliveries(): DeliveriesClient {
        return (this._deliveries ??= new DeliveriesClient(this._options));
    }

    public get redeliveries(): RedeliveriesClient {
        return (this._redeliveries ??= new RedeliveriesClient(this._options));
    }
     ...
     */
    public delete(id: string, requestOptions?: EventStreamsClient.RequestOptions): core.HttpResponsePromise<void> {
