...
export class DeliveriesClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Management.EventStreamDelivery, Management.ListEventStreamDeliveriesResponseContent>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Management.ListEventStreamDeliveriesRequestParameters,
            ): Promise<core.WithRawResponse<Management.ListEventStreamDeliveriesResponseContent>> => {
                const {
                    statuses,
        ...
        return new core.Page<Management.EventStreamDelivery, Management.ListEventStreamDeliveriesResponseContent>({
