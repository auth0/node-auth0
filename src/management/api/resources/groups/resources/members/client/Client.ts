...
export class MembersClient {
    ...
    public async get(
    ...
    ): Promise<core.Page<Management.GroupMember, Management.GetGroupMembersResponseContent>> {
            ...
            async (
                ...
                const _response = await (this._options.fetcher ?? core.fetcher)({
                    url: core.url.join(
                        ...
                        `groups/${core.url.encodePathParam(id)}/members`,
                    ),
                    method: "GET",
                    headers: _headers,
        ...
        return new core.Page<Management.GroupMember, Management.GetGroupMembersResponseContent>({
