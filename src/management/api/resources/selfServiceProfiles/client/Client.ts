...
export class SelfServiceProfilesClient {
    protected readonly _options: SelfServiceProfilesClient.Options;
    ...
    public get ssoTicket(): SsoTicketClient {
        return (this._ssoTicket ??= new SsoTicketClient(this._options));
    }
        ...
        return new core.Page<Management.SelfServiceProfile, Management.ListSelfServiceProfilesPaginatedResponseContent>(
            {
                ...
                hasNextPage: (response) =>
                    (response?.self_service_profiles ?? []).length >= Math.floor(request?.per_page ?? 1),
