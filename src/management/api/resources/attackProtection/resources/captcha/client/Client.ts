...
export class Captcha {
    ...
    ): core.HttpResponsePromise<Management.GetCaptchaResponseContent> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: Captcha.RequestOptions,
    ): Promise<core.WithRawResponse<Management.GetCaptchaResponseContent>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Management.GetCaptchaResponseContent, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {Management.UpdateCaptchaRequestContent} request
     * @param {Captcha.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Management.UnauthorizedError}
     * @throws {@link Management.ForbiddenError}
    ...
    public update(
        ...
        requestOptions?: Captcha.RequestOptions,
    ): core.HttpResponsePromise<Management.UpdateCaptchaResponseContent> {
    ...
    private async __update(
        request: Management.UpdateCaptchaRequestContent = {},
        requestOptions?: Captcha.RequestOptions,
    ): Promise<core.WithRawResponse<Management.UpdateCaptchaResponseContent>> {
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            this._options?.headers,
            mergeOnlyDefinedHeaders({ Authorization: await this._getAuthorizationHeader() }),
            requestOptions?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Management.UpdateCaptchaResponseContent,
                rawResponse: _response.rawResponse,
            };
        }
