...
export class EmailClient {
    ...
    ): core.HttpResponsePromise<Management.GetEmailFactorSettingsResponseContent> {
        return core.HttpResponsePromise.fromPromise(this.__get(requestOptions));
    }

    private async __get(
        requestOptions?: EmailClient.RequestOptions,
    ): Promise<core.WithRawResponse<Management.GetEmailFactorSettingsResponseContent>> {
        ...
        if (_response.ok) {
            return {
                data: _response.body as Management.GetEmailFactorSettingsResponseContent,
     ...
     * TODO: Link this endpoint to relevant documentation when available.
     *
     * @param {Management.SetEmailFactorSettingsRequestContent} request
     * @param {EmailClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public set(
        ...
        requestOptions?: EmailClient.RequestOptions,
    ): core.HttpResponsePromise<Management.SetEmailFactorSettingsResponseContent> {
    ...
    private async __set(
        request: Management.SetEmailFactorSettingsRequestContent,
        requestOptions?: EmailClient.RequestOptions,
    ): Promise<core.WithRawResponse<Management.SetEmailFactorSettingsResponseContent>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
        ...
        if (_response.ok) {
            return {
                data: _response.body as Management.SetEmailFactorSettingsResponseContent,
                rawResponse: _response.rawResponse,
            };
        }
