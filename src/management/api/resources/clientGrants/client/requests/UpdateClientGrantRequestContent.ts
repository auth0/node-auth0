...
import type { ClientGrantOrganizationNullableUsageEnum } from "../../../../types/ClientGrantOrganizationNullableUsageEnum.js";
...
export interface UpdateClientGrantRequestContent {
    ...
    scope?: string[];
    organization_usage?: ClientGrantOrganizationNullableUsageEnum | undefined;
