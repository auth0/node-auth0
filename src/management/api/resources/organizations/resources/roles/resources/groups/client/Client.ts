...
export class GroupsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<Management.RoleGroup, Management.ListOrganizationRoleGroupsResponseContent>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Management.ListOrganizationRoleGroupsRequestParameters,
            ): Promise<core.WithRawResponse<Management.ListOrganizationRoleGroupsResponseContent>> => {
        ...
        return new core.Page<Management.RoleGroup, Management.ListOrganizationRoleGroupsResponseContent>({
