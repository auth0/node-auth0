...
export class ResourceServersClient {
    protected readonly _options: ResourceServersClient.Options;
    ...
    public async list(
        ...
        return new core.Page<Management.ResourceServer, Management.ListResourceServerOffsetPaginatedResponseContent>({
            ...
            hasNextPage: (response) => (response?.resource_servers ?? []).length >= Math.floor(request?.per_page ?? 1),
     ...
     */
    public delete(id: string, requestOptions?: ResourceServersClient.RequestOptions): core.HttpResponsePromise<void> {
