 ...
 */
const OrganizationsManager = function (options) {
 ...
 *
 * @function    removeEnabledConnection
 * @memberof  module:management.OrganizationsManager.prototype
 * @example
 * var params =  { id :'ORGANIZATION_ID', connection_id: 'CONNECTION_ID' };
 *
 ...
 *
 * @function    updateEnabledConnection
 * @memberof  module:management.OrganizationsManager.prototype
 * @example
 * var params =  { id :'ORGANIZATION_ID', connection_id: 'CONNECTION_ID' };
