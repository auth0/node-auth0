...
describe("Hooks", () => {
    ...
    test("getSecrets", async () => {
        ...
        const response = await client.hooks.getSecrets("id");
        expect(response).toEqual({
            key: "value",
        });
    });

    test("createSecrets", async () => {
        const server = mockServerPool.createServer();
        const client = new ManagementClient({ token: "test", environment: server.baseUrl });
        ...
        const response = await client.hooks.createSecrets("id", {
            key: "value",
        });
        expect(response).toEqual(undefined);
    });

    test("deleteSecrets", async () => {
        const server = mockServerPool.createServer();
        const client = new ManagementClient({ token: "test", environment: server.baseUrl });
        ...
        const response = await client.hooks.deleteSecrets("id", ["string"]);
        expect(response).toEqual(undefined);
    });

    test("updateSecrets", async () => {
        const server = mockServerPool.createServer();
        const client = new ManagementClient({ token: "test", environment: server.baseUrl });
        const rawRequestBody = { key: "value" };
        ...
        const response = await client.hooks.updateSecrets("id", {
            key: "value",
        });
        expect(response).toEqual(undefined);
    });
