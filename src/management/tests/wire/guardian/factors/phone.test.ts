...
describe("PhoneClient", () => {
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/guardian/factors/phone/settings")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.guardian.factors.phone.get();
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.guardian.factors.phone.get();
        }).rejects.toThrow(Management.UnauthorizedError);
    });
    ...
    test("set (1)", async () => {
        ...
        server
            .mockEndpoint()
            .put("/guardian/factors/phone/settings")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.guardian.factors.phone.set({
            otp_length: 1,
    ...
    test("set (2)", async () => {
        ...
        await expect(async () => {
            return await client.guardian.factors.phone.set({
                otp_length: 10,
